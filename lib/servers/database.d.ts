...
export declare class DatabaseServer extends SkeletonServer {
    ...
    eth_getCode(address: web3.Data, blockNumber: web3.Quantity | web3.Tag): Promise<web3.Data>;
    ...
    eth_getLogs(filter: web3.FilterOptions): Promise<web3.LogObject[]>;
    ...
    eth_getTransactionCount(address: web3.Data, blockNumber: web3.Quantity | web3.Tag): Promise<web3.Quantity>;
    ...
    eth_newFilter(filter: web3.FilterOptions): Promise<web3.Quantity>;

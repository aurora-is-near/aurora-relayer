...
export declare class DatabaseServer extends SkeletonServer {
    ...
    eth_getCode(address: api.Data, blockNumber: api.Quantity | api.Tag): Promise<api.Data>;
    ...
    eth_getTransactionCount(address: api.Data, blockNumber: api.Quantity | api.Tag): Promise<api.Quantity>;

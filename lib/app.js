...
import { AccountID, Engine, formatU256, hexToBase58, intToHex } from '@aurora-is-near/engine';
...
export function createApp(options, provider) {
    const app = express();
...
export async function routeRPC(provider, method, params) {
    ...
    switch (method) {
        ...
        case 'eth_getBlockByHash': {
            ...
            const options = {
                contractID: AccountID.parse('aurora.test.near').unwrap(),

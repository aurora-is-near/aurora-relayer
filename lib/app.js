...
class Method extends jayson.Method {
    ...
    execute(server, requestParams, _context, callback) {
        ...
        result
            ...
            if (isExpected) {
                return callback(server.error(error.code, error.message, { timestamp }));
            }
            ...
            return callback(server.error(-32603, 'Internal error, please report a bug at <https://github.com/aurora-is-near/aurora-relayer/issues>', { timestamp }));
        });
        return null;
    }
}

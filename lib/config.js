...
export function parseConfig(options, config, env) {
    ...
    return [
        network,
        {
            ...
            getLogsBlockLimit: options.getLogsBlockLimit || config.getLogsBlockLimit || 2000,
            getLogsEventLimit: options.getLogsEventLimit || config.getLogsEventLimit || 10000,
            getLogsOnlyBlockLimit: options.getLogsOnlyBlockLimit || config.getLogsOnlyBlockLimit || 30000,

...
describe('AppServer', () => {
  ...
  describe('Aurora-Process-Result headers', () => {
    test('array of eth_sendRawTransaction and eth_getCode, result and header should present', async() => {
        ...
        .send(
          [
            ...
            },
            {
              ...
              "method": "eth_getCode",
              "params": [
                "0x79898510Bf1cF4804AF0277D61745AD3703Ab73b"
              ],
              "id": 3
            },
          ]
      ...
      expect(firstResponseTransaction.error.message).toBe('ERR_INCORRECT_NONCE')
      ...
      expect(secondResponseTransaction.error.message).toBe('ERR_INVALID_CHAIN_ID')
    ...
    test('single eth_sendRawTransaction, result and header should present', async() => {
      const response = await request(app)
        ...
        .send({
          ...
          id: 1,
          method: 'eth_sendRawTransaction',
          params: ['0xf866820b2d80837a12009423a824dd17d6571e1badd25a6247c685d68029858080849c8a82caa0492c0061415907bbbe3f474e0ceb3b7a190042a5553666e3208c251a7d79a02ba035de2b41f11f877c8f938ea6b6be682e8276bcfa347e2c0923400a890657c883'],
        })
          ...
          [
            {
              ...
              "method": "eth_getCode",
              "params": [
                "0x6d7a65d4e761ae5f6832735db18e2c32132d7ff9"
              ],
              "id": 1
            },
            {
